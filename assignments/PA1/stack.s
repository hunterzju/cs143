...
StackCommand_dispTab:
	...
	.word	A2I.i2a
	.word	A2I.i2a_aux
	.word	StackCommand.set_stack_top
	.word	StackCommand.get_stack_top
	.word	StackCommand.push_command
	.word	StackCommand.pop_command
	.word	StackCommand.execute_plus
	.word	StackCommand.execute_s
	.word	StackCommand.evalute_stack_top
	.word	StackCommand.display_stack
	.word	StackCommand.stop
StackNode_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
	.word	StackNode.init
	.word	StackNode.put_new_cmd
	.word	StackNode.set_next
	.word	StackNode.get_cmd
...
label122:
	...
	addiu	$sp $sp 20
	jr	$ra	
StackCommand.evalute_stack_top:
	addiu	$sp $sp -20
	sw	$fp 20($sp)
	sw	$s0 16($sp)
	sw	$ra 12($sp)
